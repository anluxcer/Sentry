...
class SentryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testLoggingInUser()
    {
        ...
        $this->session->shouldReceive('put')->with(['foo', 'persist_code'])->once();
    ...
    {
        $this->session->shouldReceive('get')->once()->andReturn(['foo', 'persist_code']);
    ...
    {
        $this->session->shouldReceive('get')->once();
        $this->cookie->shouldReceive('get')->once()->andReturn(['foo', 'persist_code']);
    ...
    {
        $this->session->shouldReceive('get')->once()->andReturn(['we', 'should', 'never', 'have', 'more', 'than', 'two']);
    ...
    public function testCreateGroup()
    {
        ...
        $this->assertTrue($this->sentry->createGroup([]));
    }
    ...
    public function testFindUserByCredentials()
    {
        ...
        $this->assertTrue($this->sentry->findUserByCredentials([]));
    }
    ...
    public function testFindAllUsersWithAnyAccess()
    {
        ...
        $this->assertTrue($this->sentry->findAllUsersWithAnyAccess([]));
    }

    public function testCreateUser()
    {
        $this->userProvider->shouldReceive('create')->once()->andReturn(true);
        $this->assertTrue($this->sentry->createUser([]));
    }
